...
<div id="page-content" class="page-wrapper clearfix">
    <div class="clearfix grid-button">
        <ul id="client-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
           <li><a role="presentation" data-bs-toggle="tab" href="#overview" ><?php echo app_lang('overview'); ?></a></li>
            ...
            <div class="tab-title clearfix no-border">
                <div class="title-button-group">
                    ...
                    if ($can_edit_clients) {
                        ...
                        echo modal_anchor(get_uri("clients/import_clients_modal_form"), "<i data-feather='upload' class='icon-16'></i> " . "Import Customer", array("class" => "btn btn-default", "title" => "Import Customer", "id" => "import-btn"));
                        echo modal_anchor(get_uri("clients/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . "Add Customer", array("class" => "btn btn-default", "title" => app_lang('add_client')));
                    }
                    ?>
                </div>
            </div>
    ...
    $(document).ready(function () {
        ...
        $(".nav-tabs li").click(function () {
            ...
            if (activeField === "#contacts") {
                ...
                importButton.attr("data-action-url", "<?php echo get_uri("clients/import_clients_modal_form"); ?>");
