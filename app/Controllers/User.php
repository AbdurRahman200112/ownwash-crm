...
class User extends Security_Controller {
    ...
    function index($tab = "") {
        ...
        return $this->template->rander("user/index", $view_data);
    }
    ...
    function modal_form() {
        ...
        return $this->template->view('user/modal_form', $view_data);
    }
    ...
    private function _make_row($data, $custom_fields) {
        ...
        $row_data[] = modal_anchor(get_uri("user/modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('edit_client'), "data-post-id" => $data->id))
                . js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_client'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("user/delete"), "data-action" => "delete-confirmation"));
    ...
    function view($client_id = 0, $tab = "") {
        ...
        if ($client_id) {
            ...
            if ($client_info && !$client_info->is_lead) {
                ...
                return $this->template->rander("user/view", $view_data);
            } else {
                show_404();
            }
        } else {
    ...
    function add_remove_star($client_id, $type = "add") {
        if ($client_id) {
            ...
            if ($type === "add") {
                ...
                return $this->template->view('user/star/starred', $view_data);
            } else {
                $this->Clients_model->add_remove_star($client_id, $this->login_user->id, $type = "remove");
                return $this->template->view('user/star/not_starred', $view_data);
            }
        }
    }
    ...
    function show_my_starred_clients() {
        ...
        return $this->template->view('users/star/clients_list', $view_data);
    }
    ...
    function projects($client_id) {
        ...
        return $this->template->view("user/projects/index", $view_data);
    }
    ...
    function payments($client_id) {
        ...
        if ($client_id) {
            ...
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("user/payments/index", $view_data);
        }
    }
    ...
    function tickets($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("user/tickets/index", $view_data);
        }
    }
    ...
    function invoices($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("user/invoices/index", $view_data);
        }
    }
    ...
    function estimates($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("user/estimates/estimates", $view_data);
        }
    }
    ...
    function orders($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("user/orders/orders", $view_data);
        }
    }
    ...
    function estimate_requests($client_id) {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("user/estimates/estimate_requests", $view_data);
        }
    }
    ...
    function notes($client_id) {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("user/notes/index", $view_data);
        }
    }
    ...
    function files($client_id, $view_type = "") {
        ...
        if ($view_type == "page_view") {
            ...
            return $this->template->rander("user/files/index", $view_data);
        } else {
            return $this->template->view("user/files/index", $view_data);
        }
    }
    ...
    function file_modal_form() {
        ...
        return $this->template->view('user/files/modal_form', $view_data);
    }
    ...
    private function _make_file_row($data) {
        ...
        $options = anchor(get_uri("user/download_file/" . $data->id), "<i data-feather='download-cloud' class='icon-16'></i>", array("title" => app_lang("download")));
    ...
    function view_file($file_id = 0) {
        ...
        if ($file_info) {
            ...
            return $this->template->view("user/files/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function contact_profile($contact_id = 0, $tab = "") {
        ...
        if ($view_data['user_info']->user_type === "client") {
            ...
            return $this->template->rander("user/contacts/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function account_settings($contact_id) {
        ...
        $view_data['can_edit_clients'] = $this->can_edit_clients();
        $this->_validate_client_view_access($view_data['user_info']->client_id);
        return $this->template->view("user/account_settings", $view_data);
    }
    ...
    function my_preferences() {
        ...
        return $this->template->view("user/contacts/my_preferences", $view_data);
    }
    ...
    function contacts($client_id = 0) {
        ...
        return $this->template->view("user/contacts/index", $view_data);
    }
    ...
    function add_new_contact_modal_form() {
        ...
        return $this->template->view('user/contacts/modal_form', $view_data);
    }
    ...
    function contact_general_info_tab($contact_id = 0) {
        if ($contact_id) {
            ...
            return $this->template->view('user/contacts/contact_general_info_tab', $view_data);
        }
    }
    ...
    function company_info_tab($client_id = 0) {
        if ($client_id) {
            ...
            return $this->template->view('user/contacts/company_info_tab', $view_data);
        }
    }
    ...
    function contact_social_links_tab($contact_id = 0) {
        if ($contact_id) {
            ...
            $view_data['can_edit_clients'] = $this->can_edit_clients();
            return $this->template->view('user/social_links', $view_data);
        }
    }
    ...
    private function _make_contact_row($data, $custom_fields, $hide_primary_contact_label = false) {
        ...
        $contact_link = anchor(get_uri("user/contact_profile/" . $data->id), $full_name . $primary_contact) . $removal_request_pending;
        if ($this->login_user->user_type === "client") {
        ...
        $row_data = array(
            $user_avatar,
            $contact_link,
            anchor(get_uri("user/view/" . $data->client_id), $client_info->company_name),
            $data->job_title,
            $data->email,
        ...
        $row_data[] = js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_contact'), "class" => "delete", "data-id" => "$data->id", "data-action-url" => get_uri("user/delete_contact"), "data-action" => "delete"));
    ...
    function invitation_modal() {
        ...
        $view_data["client_info"] = $this->Clients_model->get_one($client_id);
        return $this->template->view('user/contacts/invitation_modal', $view_data);
    }
    ...
    function users() {
        if ($this->login_user->user_type === "client") {
            ...
            return $this->template->rander("user/contacts/users", $view_data);
        }
    }
    ...
    function import_clients_modal_form() {
        ...
        return $this->template->view("user/import_clients_modal_form");
    }
    ...
    function gdpr() {
        $view_data["user_info"] = $this->Users_model->get_one($this->login_user->id);
        return $this->template->view("user/contacts/gdpr", $view_data);
    }
    ...
    function expenses($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("user/expenses/index", $view_data);
        }
    }
    ...
    function contracts($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("users/contracts/contracts", $view_data);
        }
    }
    ...
    function clients_list() {
        ...
        return $this->template->view("user/clients_list", $view_data);
    }
    ...
    function proposals($client_id) {
        ...
        if ($client_id) {
            ...
            return $this->template->view("user/proposals/proposals", $view_data);
        }
    }
    ...
    function tasks($client_id) {
        ...
        $view_data['client_id'] = clean_data($client_id);
        return $this->template->view("user/tasks/index", $view_data);
    }
}
